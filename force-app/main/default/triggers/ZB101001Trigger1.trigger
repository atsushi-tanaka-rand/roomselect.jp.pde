//取引先トリガ
trigger ZB101001Trigger1 on Account (before insert, after insert, before update, after update, 
before delete, after delete, after undelete) {
 ...
 ZB101001TriggerHandler1 handler = new ZB101001TriggerHandler1(Trigger.isExecuting, Trigger.size);
